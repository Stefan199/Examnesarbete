...
uint8_t X0, X1;
int check = 0, val = 49, message = 0, m = 0 , r = 0, g = 0, full, x=1;
double dps,rpm = 0;
...
void loop() {
  ...
  // The 2000 represent the maximum range the gyrosensor was sett to measure
...
void test(){
  Wire.beginTransmission(BMI270);
    Wire.write(0x21);             //Checking for error bit/message (INTERNAL_STATUS)
  Wire.endTransmission();

  Wire.requestFrom(BMI270,1);
